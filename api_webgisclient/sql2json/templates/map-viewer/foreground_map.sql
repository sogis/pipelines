...
constant_fields AS (
  SELECT
    ...
    CAST('[{"name":"hintergrundkarte_sw","printLayer":"ch.so.agi.hintergrundkarte.bjsvwjek","visibility":true},{"name":"hintergrundkarte_farbig","printLayer":"2_hintergrundkarte_farbig"},{"name":"hintergrundkarte_ortho","printLayer":"3_hintergrundkarte_ortho"}]' AS jsonb) AS const_wmts_background,
