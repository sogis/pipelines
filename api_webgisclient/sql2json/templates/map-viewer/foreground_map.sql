...
constant_fields AS (
  SELECT
    ...
    CAST('[{"name":"wgc_hintergrundkarte_sw","printLayer":"ch.so.agi.hintergrundkarte_sw","visibility":true},{"name":"wgc_hintergrundkarte_farbig","printLayer":"ch.so.agi.hintergrundkarte_farbig"},{"name":"wgc_hintergrund_ortho","printLayer":"ch.so.agi.hintergrundkarte_ortho"}]' AS jsonb) AS const_wmts_background,
